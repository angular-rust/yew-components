...
/// Props for [`OffIconButtonToggle`]
#[derive(Properties, Clone)]
pub struct OffIconButtonToggleProps {
    pub children: Children,
}

/// Defines header for [`IconButtonToggle`][crate::IconButtonToggle].
///
...
pub struct OffIconButtonToggle {
    props: OffIconButtonToggleProps,
}

impl Component for OffIconButtonToggle {
    type Message = ();
